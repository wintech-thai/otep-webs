    ...
    <div className="space-y-6 h-[calc(100vh-140px)] flex flex-col"> 
      ...
      <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex flex-col md:flex-row gap-4 justify-between items-center shrink-0">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto flex-1 max-w-2xl">
            ...
            <button className="h-[42px] w-[42px] bg-blue-400 hover:bg-blue-500 text-white rounded-lg flex items-center justify-center transition-colors shadow-sm shadow-blue-200">
                <Search size={20} />
            </button>
        </div>
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-end">
            <button className="flex items-center gap-2 px-5 py-2.5 bg-blue-400 hover:bg-blue-500 text-white text-sm font-semibold rounded-lg shadow-sm shadow-blue-200 transition-all active:scale-95">
                ...
                <thead>
                    <tr className="border-b border-slate-100 bg-slate-50/50">
                        <th className="p-4 w-[50px]">
                            <input type="checkbox" className="w-4 h-4 rounded border-slate-300 text-blue-500 focus:ring-blue-200" disabled />
                        </th>
                        <th className="p-4 text-sm font-semibold text-slate-800">{t.username}</th>
                        <th className="p-4 text-sm font-semibold text-slate-800">{t.email}</th>
                        <th className="p-4 text-sm font-semibold text-slate-800">{t.tags}</th>
                        ...
                        <th className="p-4 text-sm font-semibold text-slate-800 text-center">{t.initialUser}</th>
